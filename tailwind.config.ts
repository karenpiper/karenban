  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        sm: ["0.6875rem", { lineHeight: "1.4", letterSpacing: "-0.01em" }],
        base: ["0.75rem", { lineHeight: "1.4", letterSpacing: "-0.01em" }],
        lg: ["0.875rem", { lineHeight: "1.4", letterSpacing: "-0.02em" }],
        xl: ["1rem", { lineHeight: "1.3", letterSpacing: "-0.02em" }],
        "2xl": ["1.125rem", { lineHeight: "1.2", letterSpacing: "-0.02em" }],
        "3xl": ["1.25rem", { lineHeight: "1.1", letterSpacing: "-0.03em" }],
      },
      fontWeight: {
        normal: "400",
        medium: "500",
