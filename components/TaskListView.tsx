...
import { ArrowUpDown, ArrowUp, ArrowDown, Search, Calendar, User, Building2, FolderKanban, X, Pencil } from "lucide-react"
            ...
            <tbody>
              {filteredAndSortedTasks.length > 0 ? (
                filteredAndSortedTasks.map((task) => (
                  <tr
                    key={task.id}
                    className="border-b border-gray-200/10 hover:bg-gray-50/40 transition-colors cursor-pointer"
